...
export async function start_webgpu_engine(o: EngineSettings.WebGPU) {
	const engine = new WebGPUEngine(o.canvas, o.webgpu)
	await engine.initAsync()
	return engine
}

export async function start_webgl_engine(o: EngineSettings.WebGL) {
	return new Engine(o.canvas, undefined, o.webgl)
}

export async function start_engine(o: EngineSettings.Auto) {
	const webgpuSupported = await WebGPUEngine.IsSupportedAsync
	return (o.webgpu && webgpuSupported)
		? await start_webgpu_engine({...o, webgpu: o.webgpu})
		: await start_webgl_engine(o)
}
